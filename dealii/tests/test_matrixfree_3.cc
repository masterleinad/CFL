...
//    Typically there is nothing more to test since the member functions ultimately call
// dealii library functions.
...
BOOST_FIXTURE_TEST_CASE(FEObjMemFunc, FEFixture, *utf::tolerance(0.00001))
{
  ...
  // fe_function_scalar.set_evaluation_flags(); possible Issue
  ...
  // FELiftDivergence<decltype(fe_divergence)> lifted_divergence(fe_divergence); //TBD, yet to
  // analyze
