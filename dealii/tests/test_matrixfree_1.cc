...
struct TestDatafunctor
{
  ...
  run()
  {
    ...
    BOOST_TEST(test_obj3.integration_flags.value_exterior == i_comb["TestSymmetricGradient"].second);
    BOOST_TEST(test_obj3.integration_flags.gradient == i_comb["TestSymmetricGradient"].third);
    BOOST_TEST(test_obj3.integration_flags.gradient_exterior == i_comb["TestSymmetricGradient"].fourth);
    ...
    BOOST_TEST(test_obj7.integration_flags.value_exterior == i_comb["TestFunctionInteriorFace"].second);
    BOOST_TEST(test_obj7.integration_flags.gradient == i_comb["TestFunctionInteriorFace"].third);
    BOOST_TEST(test_obj7.integration_flags.gradient_exterior == i_comb["TestFunctionInteriorFace"].fourth);
    ...
    BOOST_TEST(test_obj8.integration_flags.value_exterior == i_comb["TestFunctionExteriorFace"].second);
    BOOST_TEST(test_obj8.integration_flags.gradient == i_comb["TestFunctionExteriorFace"].third);
    BOOST_TEST(test_obj8.integration_flags.gradient_exterior == i_comb["TestFunctionExteriorFace"].fourth);
    ...
    BOOST_TEST(test_obj9.integration_flags.value_exterior == i_comb["TestNormalGradientInteriorFace"].second);
    BOOST_TEST(test_obj9.integration_flags.gradient == i_comb["TestNormalGradientInteriorFace"].third);
    BOOST_TEST(test_obj9.integration_flags.gradient_exterior == i_comb["TestNormalGradientInteriorFace"].fourth);
    ...
    BOOST_TEST(test_obj10.integration_flags.value == i_comb["TestNormalGradientExteriorFace"].first);
    BOOST_TEST(test_obj10.integration_flags.value_exterior == i_comb["TestNormalGradientExteriorFace"].second);
    BOOST_TEST(test_obj10.integration_flags.gradient == i_comb["TestNormalGradientExteriorFace"].third);
    BOOST_TEST(test_obj10.integration_flags.gradient_exterior == i_comb["TestNormalGradientExteriorFace"].fourth);
...
typename TestDatafunctor<i>::comb_map_t TestDatafunctor<i>::i_comb = {
  { "TestFunction", {true,false,false,false} }, { "TestDivergence", {false,false,true,false} },
  { "TestSymmetricGradient", {false,false,true,false} }, { "TestCurl", {false,false,true,false} },
  { "TestGradient", {false,false,true,false} }, { "TestHessian", {false,false,false,false} },
