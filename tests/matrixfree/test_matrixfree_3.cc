...
BOOST_FIXTURE_TEST_CASE(FEObjMemFunc, FEFixture, *utf::tolerance(0.00001))
{
  ...
  Base::FEFunction<0, dim, fe_no_0> fe_function_scalar1;
  ...
  Base::FEFunction<1, dim, fe_no_0> fe_function_vector1;
  ...
  Base::FEGradient<1, dim, fe_no_0> fe_gradient_scalar1 = grad(fe_function_scalar1);
  ...
  Base::FEGradient<2, dim, fe_no_0> fe_gradient_vector1 = grad(fe_function_vector1);
  ...
  Base::FEDivergence<0, dim, fe_no_0> fe_divergence1 = div(fe_function_vector1);
  ...
  Base::FELiftDivergence<decltype(fe_divergence1)> lifted_divergence1(fe_divergence1);
  ...
  Base::FESymmetricGradient<1, dim, fe_no_0> fe_symmetric_gradient1;
  ...
  Base::FECurl<1, dim, fe_no_0> fe_curl1;
  ...
  Base::FELaplacian<0, dim, fe_no_0> fe_laplacian1 = div(fe_gradient_scalar1);
  ...
  Base::FEDiagonalHessian<2, dim, fe_no_0> fe_diagonal_hessian1;
  ...
  Base::FEHessian<2, dim, fe_no_0> fe_hessian1;
  ...
  Base::FEFunctionInteriorFace<2, dim, fe_no_0> fe_int_face1;
  ...
  Base::FEFunctionExteriorFace<2, dim, fe_no_0> fe_ext_face1;
  ...
  Base::FENormalGradientInteriorFace<2, dim, fe_no_0> fe_gint_face1;
  ...
  Base::FENormalGradientExteriorFace<2, dim, fe_no_0> fe_gext_face1;
